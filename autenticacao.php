...
<head>
    ...
    <style>
        ...
        .bg { 
            /* The image used */
            background-image: url("image/BLOG_648x430pxIMG-3.png");
            /* Full height */
            height: 100%; 
    ...
    <div class="container">
        <div class="row">
            <div class="col-md-6 offset-md-3"  style="background: white; padding: 20px; box-shadow: 10px 10px 5px #888888; margin-top: 100px;">
                <h1><center>Autenticação em 2fa<center></h1>
                <p style="font-style: italic;"><center>Favor utilizar o app do Google Authenticator para escanear o QRCode<center></p>
                <hr>
                <form action="check.php" method="post">
                    <div style="text-align: center;">
                        <?php if ($_SESSION['failed']): ?>
                            <div class="alert alert-danger" role="alert">
                                        <strong>Ah, droga !!!</strong> Código Inválido.
                            </div>
                            <?php   
                                $_SESSION['failed'] = false;
                            ?>
